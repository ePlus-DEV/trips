...
<!-- API_USAGE_START -->
> Cập nhật tự động: **2026-09-04T04:43:55.798Z**. Số **Đã dùng** lấy trực tiếp từ `this_month_usage`, nên lần chạy đầu tiên cũng tính luôn credit đã sử dụng trước khi tính năng thống kê được thêm vào.

| API / credential | Vai trò | Đã dùng / Tổng kỳ | Còn lại | Reset / gia hạn | Plan |
|---|---|---:|---:|---|---|
| Flight + Hotel Search #1 | Theo dõi giá vé + phòng | 88 / 250 | 162 | 2026-09-20 | Free Plan |
