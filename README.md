...
<!-- API_USAGE_START -->
> Cập nhật tự động: **2026-09-06T04:49:53.513Z**. Số **Đã dùng** lấy trực tiếp từ `this_month_usage`, nên lần chạy đầu tiên cũng tính luôn credit đã sử dụng trước khi tính năng thống kê được thêm vào.

| API / credential | Vai trò | Đã dùng / Tổng kỳ | Còn lại | Reset / gia hạn | Plan |
|---|---|---:|---:|---|---|
| Flight + Hotel Search #1 | Theo dõi giá vé + phòng | 98 / 250 | 152 | 2026-09-20 | Free Plan |
