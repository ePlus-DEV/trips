const CACHE='travel-log-ui-pr-v8';
const ASSETS=['./','./index.html','./flights.html','./flights/','./app.css','./base.css','./motion.css','./loading.css','./theme-icon.css','./flight-booking.css','./flight-booking.js','./assets/china-hero.svg','./manifest.webmanifest','./icon.svg'];
